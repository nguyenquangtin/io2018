...
IOWA.CountdownTimer.Core.prototype.addUnits = function() {
    ...
    e.save(), e.scale(this.pixelRatio, this.pixelRatio), e.font = "500 12px Raleway", e.fillStyle = "#78909C", e.textAlign = "center", e.fillText("Ngày", this.bands[0].center.x + this.layout.radius + this.bandPadding / 2, this.bands[0].center.y + this.layout.radius + t), e.fillText("Giờ", this.bands[2].center.x + this.layout.radius + this.bandPadding / 2, this.bands[2].center.y + this.layout.radius + t), e.fillText("Phút", this.bands[4].center.x + this.layout.radius + this.bandPadding / 2, this.bands[4].center.y + this.layout.radius + t), e.fillText("Giây", this.bands[6].center.x + this.layout.radius + this.bandPadding / 2, this.bands[6].center.y + this.layout.radius + t), e.restore()
};
